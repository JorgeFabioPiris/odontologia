...
uses
  ...
  Odontologia.Modelo.Medico.Interfaces in 'src\modelo\medico\Odontologia.Modelo.Medico.Interfaces.pas',
  Odontologia.Modelo.Medico in 'src\modelo\medico\Odontologia.Modelo.Medico.pas',
  Odontologia.Modelo.Paciente.Interfaces in 'src\modelo\paciente\Odontologia.Modelo.Paciente.Interfaces.pas',
  Odontologia.Modelo.Paciente in 'src\modelo\paciente\Odontologia.Modelo.Paciente.pas',
  Odontologia.Controlador.Medico.Interfaces in 'src\controlador\medico\Odontologia.Controlador.Medico.Interfaces.pas',
  Odontologia.Controlador.Medico in 'src\controlador\medico\Odontologia.Controlador.Medico.pas',
  Odontologia.Controlador.Paciente.Interfaces in 'src\controlador\paciente\Odontologia.Controlador.Paciente.Interfaces.pas',
  Odontologia.Controlador.Paciente in 'src\controlador\paciente\Odontologia.Controlador.Paciente.pas',
  Odontologia.Modelo.Agenda.Interfaces in 'src\modelo\agenda\Odontologia.Modelo.Agenda.Interfaces.pas',
  Odontologia.Modelo.Agenda in 'src\modelo\agenda\Odontologia.Modelo.Agenda.pas',
  Odontologia.Modelo.Entidades.Estado.Cita in 'src\modelo\entidades\Odontologia.Modelo.Entidades.Estado.Cita.pas',
  Odontologia.Modelo.Estado.Cita.Interfaces in 'src\modelo\estado_cita\Odontologia.Modelo.Estado.Cita.Interfaces.pas',
  Odontologia.Modelo.Estado.Cita in 'src\modelo\estado_cita\Odontologia.Modelo.Estado.Cita.pas',
  Odontologia.Controlador.Estado.Cita.Interfaces in 'src\controlador\estado_cita\Odontologia.Controlador.Estado.Cita.Interfaces.pas',
  Odontologia.Controlador.Estado.Cita in 'src\controlador\estado_cita\Odontologia.Controlador.Estado.Cita.pas',
...
begin
  ...
  Application.CreateForm(TPagPaciente, PagPaciente);
  Application.CreateForm(TPagMedico, PagMedico);
  Application.Run;
end.
